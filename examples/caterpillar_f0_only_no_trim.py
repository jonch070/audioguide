# Spectral Reconstruction: FUNDAMENTAL ONLY without Trimming
# Only matches fundamental frequencies (f0) and uses full corpus file duration
...
# Output files
RPP_FILEPATH = '/Applications/AudioGuide/test_output/caterpillar_f0_no_trim.rpp'
CSOUND_RENDER_FILEPATH = '/Applications/AudioGuide/test_output/caterpillar_f0_no_trim.wav'
HTML_LOG_FILEPATH = '/Applications/AudioGuide/test_output/caterpillar_f0_no_trim_log.html'
