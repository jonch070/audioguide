# FluCoMa Novelty Slice - Real World Example
#
# This example uses FluCoMa noveltyslice on a real musical track
# from "The Caterpillar Knight" album, demonstrating practical usage
# with polyphonic source material.
#
...
#   noveltyslice('/Users/jonathankawchuk/Downloads/The Caterpillar Knight/The Caterpillar Knight-005.wav', algorithm=0, threshold=0.5)
#   "

VERBOSITY = 1

# TARGET: Real musical track with FluCoMa novelty slice segmentation
# Segmentation detects major spectral changes / section changes in the music
TARGET = tsf(
...
SPECTRAL_SCALE_TYPE = 'major'  # Or will auto-detect major/minor
...
# Output files
RPP_FILEPATH = '/Applications/AudioGuide/test_output/caterpillar_flucoma_realworld.rpp'
CSOUND_RENDER_FILEPATH = '/Applications/AudioGuide/test_output/caterpillar_flucoma_realworld.wav'
HTML_LOG_FILEPATH = '/Applications/AudioGuide/test_output/caterpillar_flucoma_realworld_log.html'
